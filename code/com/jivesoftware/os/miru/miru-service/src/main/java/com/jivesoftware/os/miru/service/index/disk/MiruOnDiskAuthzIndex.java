...
public class MiruOnDiskAuthzIndex<BM> implements MiruAuthzIndex<BM>, BulkImport<Map<String, MiruInvertedIndex<BM>>> {
    ...
    public MiruOnDiskAuthzIndex(MiruBitmaps<BM> bitmaps, File mapDirectory, File swapDirectory, ChunkStore chunkStore, MiruAuthzCache<BM> cache) throws Exception {
