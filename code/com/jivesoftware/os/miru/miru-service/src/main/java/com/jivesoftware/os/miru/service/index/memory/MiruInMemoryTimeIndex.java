...
public class MiruInMemoryTimeIndex implements MiruTimeIndex, BulkImport<long[]>, BulkExport<MiruTimeIndex> {
    ...
    private final Map<Long, Integer> timestampToIndex = Maps.newConcurrentMap();
    ...
    public Iterable<Entry> getEntries() {
        return Iterables.transform(timestampToIndex.entrySet(), new Function<Map.Entry<Long, Integer>, Entry>() {
            @Nullable
            @Override
            public Entry apply(@Nullable Map.Entry<Long, Integer> input) {
