...
import static com.jivesoftware.os.miru.service.benchmark.MiruStreamServiceBenchmarkUtils.generateActivity;
...
public enum MiruCustomerSize {
    SMALL_CUSTOMER {
        ...
        private final Map<MiruFieldName, Integer> fieldNameToTotalCount = ImmutableMap.<MiruFieldName, Integer>builder()
            ...
            .put(MiruFieldName.AUTHZ, 10_000)
    ...
    MEDIUM_CUSTOMER {
        ...
        public final Map<MiruFieldName, Integer> fieldNameToTotalCount = ImmutableMap.<MiruFieldName, Integer>builder()
            ...
            .put(MiruFieldName.AUTHZ, 100_000)
    ...
    LARGE_CUSTOMER {
        ...
        private final Map<MiruFieldName, Integer> fieldNameToTotalCount = ImmutableMap.<MiruFieldName, Integer>builder()
            ...
            .put(MiruFieldName.AUTHZ, 1_000_000)
