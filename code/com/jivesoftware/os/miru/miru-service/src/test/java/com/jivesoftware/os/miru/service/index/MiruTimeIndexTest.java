...
public class MiruTimeIndexTest {
    ...
    */
    ...
    public void testPerformance() throws Exception {
        ...
        for (int levels : tryLevels) {
            for (int segments : trySegments) {
                ...
                MiruOnDiskTimeIndex onDiskTimeIndex = new MiruOnDiskTimeIndex(new MiruFilerProvider() {
                    @Override
                ...
                onDiskTimeIndex.bulkImport(inMemoryTimeIndex);
    ...
    public Object[][] miruTimeIndexDataProviderWithData() throws Exception {
        ...
        MiruOnDiskTimeIndex miruMemMapTimeIndex = new MiruOnDiskTimeIndex(new MiruFilerProvider() {
            @Override
            public File getBackingFile() {
                return memMap;
            }
        ...
        miruMemMapTimeIndex.bulkImport(miruInMemoryTimeIndex);
