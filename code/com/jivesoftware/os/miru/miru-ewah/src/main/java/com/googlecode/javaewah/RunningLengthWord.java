...
public final class RunningLengthWord implements Cloneable {
        ...
        public int getNumberOfLiteralWords() {
                return (int) (this.parent.buffer.get(this.position) >>> (1 + runninglengthbits));
        }
        ...
        public boolean getRunningBit() {
                return (this.parent.buffer.get(this.position) & 1) != 0;
        }
        ...
        public long getRunningLength() {
                return (this.parent.buffer.get(this.position) >>> 1)
        ...
        public void setNumberOfLiteralWords(final long number) {
                long val = this.parent.buffer.get(this.position) | notrunninglengthplusrunningbit;
                this.parent.buffer.put(this.position, val & ((number << (runninglengthbits + 1))
        ...
        public void setRunningBit(final boolean b) {
                if (b)
                        this.parent.buffer.put(this.position, this.parent.buffer.get(this.position) | 1l);
                else
                        this.parent.buffer.put(this.position, this.parent.buffer.get(this.position) & ~1l);
        }
        ...
        public void setRunningLength(final long number) {
                long val = this.parent.buffer.get(this.position) | shiftedlargestrunninglengthcount;
                this.parent.buffer.put(this.position, val & ((number << 1) | notshiftedlargestrunninglengthcount));
        }
        ...
        /** The array of words. */
        public com.googlecode.javaewah.EWAHCompressedBitmap parent;
