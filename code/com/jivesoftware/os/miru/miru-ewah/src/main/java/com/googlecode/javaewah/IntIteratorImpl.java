 ...
 * @since 0.5.6
 */
final class IntIteratorImpl implements com.googlecode.javaewah.IntIterator {

        private final com.googlecode.javaewah.EWAHIterator ewahIter;
        private final LongBuffer ewahBuffer;
        ...
        IntIteratorImpl(com.googlecode.javaewah.EWAHIterator ewahIter) {
        ...
        private final void setRunningLengthWord(com.googlecode.javaewah.RunningLengthWord rlw) {
        ...
        private final boolean literalHasNext() {
                while (this.word == 0 && this.wordPosition < this.wordLength) {
                        this.word = this.ewahBuffer.get(this.wordPosition++);
