...
public final class EWAHIterator implements Cloneable {
         ...
         *                of words
         */
        public EWAHIterator(final com.googlecode.javaewah.EWAHCompressedBitmap a, final int sizeinwords) {
         ...
         * @return an iterator
         */
        public static EWAHIterator getEWAHIterator(com.googlecode.javaewah.EWAHCompressedBitmap bitmap) {
