 ...
 */
public class RunningBitmapMerge implements com.googlecode.javaewah.symmetric.BitmapSymmetricAlgorithm {

        @Override
        public void symmetric(UpdateableBitmapFunction f, com.googlecode.javaewah.BitmapStorage out,
                com.googlecode.javaewah.EWAHCompressedBitmap... set) {
                final com.googlecode.javaewah.datastructure.PriorityQ<EWAHPointer> H = new com.googlecode.javaewah.datastructure.PriorityQ<EWAHPointer>(
                ...
                for (int k = 0; k < set.length; ++k) {
                        final EWAHPointer x = new EWAHPointer(0,
                                new com.googlecode.javaewah.IteratingBufferedRunningLengthWord(set[k]),
                                k);
                        if (x.hasNoData())
                                continue;
                        f.rw[k] = x;
