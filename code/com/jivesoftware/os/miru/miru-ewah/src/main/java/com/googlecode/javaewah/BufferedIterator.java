 ...
 * 
 */
public class BufferedIterator implements com.googlecode.javaewah.IteratingRLW {
        /**
        ...
        public long getLiteralWordAt(int index) {
                return this.buffer.get(this.literalWordStartPosition + index);
        }
        ...
        private com.googlecode.javaewah.CloneableIterator<com.googlecode.javaewah.EWAHIterator> masteriterator;
}
