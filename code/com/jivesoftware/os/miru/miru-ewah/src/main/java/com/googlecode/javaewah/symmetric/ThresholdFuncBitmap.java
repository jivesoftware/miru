 ...
 * 
 */
public final class ThresholdFuncBitmap extends com.googlecode.javaewah.symmetric.UpdateableBitmapFunction {
        private int min;
        ...
        @Override
        public void dispatch(com.googlecode.javaewah.BitmapStorage out, int runbegin, int runend) {
        ...
        private final void orLiterals(final com.googlecode.javaewah.BitmapStorage out,
                final int runbegin, final int runlength) {
                for (int i = 0; i < runlength; ++i) {
                        long w = 0;
                        for (com.googlecode.javaewah.symmetric.EWAHPointer R : this.getLiterals()) {
        ...
        private final void andLiterals(final com.googlecode.javaewah.BitmapStorage out,
                final int runbegin, final int runlength) {
                for (int i = 0; i < runlength; ++i) {
                        long w = ~0;
                        for (com.googlecode.javaewah.symmetric.EWAHPointer R : this.getLiterals()) {
        ...
        private final void generalLiterals(final int deficit,
                final com.googlecode.javaewah.BitmapStorage out, final int runbegin, final int runlength) {
