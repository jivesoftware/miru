...
public final class EWAHCompressedBitmap implements Cloneable, Externalizable,
        Iterable<Integer>, BitmapStorage, com.googlecode.javaewah.LogicalElement<EWAHCompressedBitmap> {

        /**
         * Creates an empty bitmap (no bit set to true).
         */
        public EWAHCompressedBitmap() {
                this.buffer = ByteBuffer.allocateDirect(defaultbuffersize * 8)
        ...
        public EWAHCompressedBitmap(final int buffersize) {
                this.buffer = ByteBuffer.allocateDirect(buffersize * 8)
                        .order(ByteOrder.nativeOrder())
                        .asLongBuffer();
                this.rlw = new RunningLengthWord(this, 0);
        }
         ...
         */
        @Override
        public void addStreamOfLiteralWords(final LongBuffer data, final int start,
                final int number) {
         ...
         */
        @Override
        public void addStreamOfNegatedLiteralWords(final LongBuffer data,
        ...
        public void andToContainer(final EWAHCompressedBitmap a,
                ...
                final com.googlecode.javaewah.IteratingBufferedRunningLengthWord rlwi = new com.googlecode.javaewah.IteratingBufferedRunningLengthWord(
                        i);
                final com.googlecode.javaewah.IteratingBufferedRunningLengthWord rlwj = new com.googlecode.javaewah.IteratingBufferedRunningLengthWord(
                        j);
                while ((rlwi.size() > 0) && (rlwj.size() > 0)) {
                        while ((rlwi.getRunningLength() > 0)
                                ...
                                final boolean i_is_prey = rlwi
                                        ...
                                        .getRunningLength();
                                final com.googlecode.javaewah.IteratingBufferedRunningLengthWord prey = i_is_prey ? rlwi
                                        : rlwj;
                                final com.googlecode.javaewah.IteratingBufferedRunningLengthWord predator = i_is_prey ? rlwj
                                        : rlwi;
                ...
                if (adjustContainerSizeWhenAggregating) {
                        ...
                        final com.googlecode.javaewah.IteratingBufferedRunningLengthWord remaining = i_remains ? rlwi
                                : rlwj;
        ...
        public int andCardinality(final EWAHCompressedBitmap a) {
                final com.googlecode.javaewah.BitCounter counter = new com.googlecode.javaewah.BitCounter();
        ...
        public int cardinality() {
                ...
                while (i.hasNext()) {
                        ...
                        for (int j = 0; j < localrlw.getNumberOfLiteralWords(); ++j) {
                                counter += Long.bitCount(i.buffer().get(i
                                        .literalWords() + j));
                        }
                }
                return counter;
        ...
        public void deserialize(DataInput in) throws IOException {
                ...
                if (this.buffer.limit() < this.actualsizeinwords) {
                        this.buffer = ByteBuffer.allocateDirect(actualsizeinwords * 8)
                                .order(ByteOrder.nativeOrder())
                                .asLongBuffer();
                }
                for (int k = 0; k < this.actualsizeinwords; ++k)
                        this.buffer.put(k, in.readLong());
                ...
                if (o instanceof EWAHCompressedBitmap) {
                        try {
                                this.xorToContainer((EWAHCompressedBitmap) o,
                                        new com.googlecode.javaewah.NonEmptyVirtualStorage());
                                return true;
                        } catch (com.googlecode.javaewah.NonEmptyVirtualStorage.NonEmptyException e) {
                                return false;
                        }
                }
                return false;
         ...
         */
        public com.googlecode.javaewah.IteratingRLW getIteratingRLW() {
                return new com.googlecode.javaewah.IteratingBufferedRunningLengthWord(this);
        }
        ...
        public List<Integer> toList() {
                ...
                while (i.hasNext()) {
                        ...
                        for (int j = 0; j < localrlw.getNumberOfLiteralWords(); ++j) {
                                long data = i.buffer().get(i.literalWords() + j);
                                while (data != 0) {
        ...
        public int hashCode() {
                ...
                while (i.hasNext()) {
                        ...
                        for (int k = 0; k < i.rlw.getNumberOfLiteralWords(); ++k) {
                                karprabin += B
                                        * karprabin
                                        + (this.buffer.get(i.literalWords() + k) & ((1l << 32) - 1));
                                karprabin += B
                                        * karprabin
                                        + (this.buffer.get(i.literalWords() + k) >>> 32);
                        }
                }
                return karprabin;
        }
        ...
        public boolean intersects(final EWAHCompressedBitmap a) {
                com.googlecode.javaewah.NonEmptyVirtualStorage nevs = new com.googlecode.javaewah.NonEmptyVirtualStorage();
                try {
                        this.andToContainer(a, nevs);
                } catch (com.googlecode.javaewah.NonEmptyVirtualStorage.NonEmptyException nee) {
                        return true;
                }
                return false;
        }
         ...
         */
        public com.googlecode.javaewah.IntIterator intIterator() {
        ...
        public Iterator<Integer> iterator() {
                return new Iterator<Integer>() {
                        ...
                        final private com.googlecode.javaewah.IntIterator under = intIterator();
                };
        }
         ...
         */
        private void negative_push_back(final LongBuffer data, final int start,
                final int number) {
                while (this.actualsizeinwords + number >= this.buffer.limit()) {
                        final LongBuffer oldbuffer = this.buffer;
                        if ((this.actualsizeinwords + number) < 32768)
                                this.buffer = ByteBuffer.allocateDirect(((this.actualsizeinwords + number) * 2) * 8)
                                        .order(ByteOrder.nativeOrder())
                                        .asLongBuffer();
                                ...
                                this.buffer = ByteBuffer.allocateDirect(((this.actualsizeinwords + number) * 3 / 2) * 8)
                                        .order(ByteOrder.nativeOrder())
                                        .asLongBuffer();
                ...
                for (int k = 0; k < number; ++k)
                        this.buffer.put(this.actualsizeinwords + k, ~data.get(start + k));
        ...
        public void not() {
                ...
                while (true) {
                        ...
                        for (int j = 0; j < rlw1.getNumberOfLiteralWords(); ++j) {
                                i.buffer().put(i.literalWords() + j, ~i.buffer().get(i
                                        .literalWords() + j));
                        }
                        ...
                        if (!i.hasNext()) {// must potentially adjust the last
                                ...
                                i.buffer().put(i.literalWords() + rlw1.getNumberOfLiteralWords() - 1,
                                        i.buffer().get(i.literalWords() + rlw1.getNumberOfLiteralWords() - 1) & ((~0l) >>> (wordinbits - usedbitsinlast)));
                                return;
                        }
                }
        }
        ...
        private void push_back(final long data) {
                if (this.actualsizeinwords == this.buffer.limit()) {
                        final LongBuffer oldbuffer = this.buffer;
                        if (oldbuffer.limit() < 32768)
                                this.buffer = ByteBuffer.allocateDirect((oldbuffer.limit() * 2) * 8)
                                        .order(ByteOrder.nativeOrder())
                                        .asLongBuffer();
                        else if (oldbuffer.limit() * 3 / 2 < oldbuffer.limit()) // overflow
                                this.buffer = ByteBuffer.allocateDirect(Integer.MAX_VALUE)
                                        .order(ByteOrder.nativeOrder())
                                        .asLongBuffer();
                        else
                                this.buffer = ByteBuffer.allocateDirect((oldbuffer.limit() * 3 / 2) * 8)
                                        .order(ByteOrder.nativeOrder())
                                        .asLongBuffer();
                        oldbuffer.position(0);
                        this.buffer.put(oldbuffer);
                ...
                this.buffer.put(this.actualsizeinwords++, data);
        }
         ...
         *                the number of words to add
         */
        private void push_back(final LongBuffer data, final int start,
                final int number) {
                if (this.actualsizeinwords + number >= this.buffer.limit()) {
                        final LongBuffer oldbuffer = this.buffer;
                        if (this.actualsizeinwords + number < 32768)
                                this.buffer = ByteBuffer.allocateDirect(((this.actualsizeinwords + number) * 2) * 8)
                                        .order(ByteOrder.nativeOrder())
                ...
                buffercopy(data, start, this.buffer, this.actualsizeinwords, number);
                this.actualsizeinwords += number;
        }
        ...
        private boolean reserve(final int size) {
                if (size > this.buffer.limit()) {
                        final LongBuffer oldbuffer = this.buffer;
                        this.buffer = ByteBuffer.allocateDirect(size * 8)
                                .order(ByteOrder.nativeOrder())
                                .asLongBuffer();
                        oldbuffer.position(0);
                        this.buffer.put(oldbuffer);
        ...
        public void serialize(DataOutput out) throws IOException {
                ...
                for (int k = 0; k < this.actualsizeinwords; ++k)
                        out.writeLong(this.buffer.get(k));
        ...
        public boolean get(final int i) {
                if ((i < 0) || (i >= this.sizeinbits))
                        return false;
                int WordChecked = 0;
                final com.googlecode.javaewah.IteratingRLW j = getIteratingRLW();
        ...
        public boolean set(final int i) {
                ...
                long val = this.buffer.get(this.actualsizeinwords - 1) | (1l << (i % wordinbits));
                if (val == ~0l) {
                        this.buffer.put(this.actualsizeinwords - 1, 0);
                    ...
                    this.buffer.put(this.actualsizeinwords - 1, val);
                }
                return true;
        }
        ...
        public static void thresholdWithContainer(
                ...
                final EWAHCompressedBitmap... bitmaps) {
                (new com.googlecode.javaewah.symmetric.RunningBitmapMerge()).symmetric(
                        new com.googlecode.javaewah.symmetric.ThresholdFuncBitmap(T), container, bitmaps);
        }
        ...
        public String toString() {
                ...
                com.googlecode.javaewah.IntIterator i = this.intIterator();
                answer.append("{");
                if (i.hasNext())
        ...
        private void buffercopy(LongBuffer src, int srcPos, LongBuffer dest, int destPos, int length) {
            LongBuffer clone = src.duplicate();
            clone.position(srcPos);
            clone.limit(Math.min((srcPos) + (length), buffer.capacity()));
