...
public final class BufferedRunningLengthWord implements Cloneable {
        ...
        public BufferedRunningLengthWord(final long a) {
                this.NumberOfLiteralWords = (int) (a >>> (1 + com.googlecode.javaewah.RunningLengthWord.runninglengthbits));
                this.RunningBit = (a & 1) != 0;
                this.RunningLength = (int) ((a >>> 1) & com.googlecode.javaewah.RunningLengthWord.largestrunninglengthcount);
        }
         ...
         *                the rlw
         */
        public BufferedRunningLengthWord(final com.googlecode.javaewah.RunningLengthWord rlw) {
                this(rlw.parent.buffer.get(rlw.position));
        }
         ...
         */
        public void reset(final com.googlecode.javaewah.RunningLengthWord rlw) {
                reset(rlw.parent.buffer.get(rlw.position));
        }
