...
public final class EWAHPointer implements Comparable<EWAHPointer> {
         ...
         * Underlying iterator
         */
        public com.googlecode.javaewah.IteratingBufferedRunningLengthWord iterator;
        ...
        public EWAHPointer(final int previousendrun,
                final com.googlecode.javaewah.IteratingBufferedRunningLengthWord rw, final int pos) {
                this.pos = pos;
                this.iterator = rw;
         ...
         */
        public void callbackUpdate(final com.googlecode.javaewah.symmetric.UpdateableBitmapFunction f) {
                if (this.dead)
                        f.setZero(this.pos);
