...
public abstract class UpdateableBitmapFunction {
        com.googlecode.javaewah.symmetric.EWAHPointer[] rw = new com.googlecode.javaewah.symmetric.EWAHPointer[0];
        int hammingWeight = 0;
        int litWeight = 0;
        boolean[] b = new boolean[0];
        final com.googlecode.javaewah.datastructure.BitSet litwlist = new com.googlecode.javaewah.datastructure.BitSet(0);
        ...
        public final Iterable<EWAHPointer> getLiterals() {
                return new Iterable<EWAHPointer>() {
                        ...
                        @Override
                        public Iterator<com.googlecode.javaewah.symmetric.EWAHPointer> iterator() {
                                return new Iterator<com.googlecode.javaewah.symmetric.EWAHPointer>() {
                                        ...
                                        @Override
                                        public com.googlecode.javaewah.symmetric.EWAHPointer next() {
                                                com.googlecode.javaewah.symmetric.EWAHPointer answer = UpdateableBitmapFunction.this.rw[this.k];
