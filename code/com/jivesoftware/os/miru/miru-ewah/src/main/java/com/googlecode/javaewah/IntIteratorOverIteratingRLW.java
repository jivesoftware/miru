 ...
 * 
 */
public class IntIteratorOverIteratingRLW implements com.googlecode.javaewah.IntIterator {
        com.googlecode.javaewah.IteratingRLW parent;
         ...
         */
        public IntIteratorOverIteratingRLW(final com.googlecode.javaewah.IteratingRLW p) {
                this.parent = p;
                this.position = 0;
