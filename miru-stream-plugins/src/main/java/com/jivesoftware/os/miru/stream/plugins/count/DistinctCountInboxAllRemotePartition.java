 ...
 *
 */
public class DistinctCountInboxAllRemotePartition implements MiruRemotePartition<DistinctCountQuery, DistinctCountAnswer, DistinctCountReport> {
    ...
    public DistinctCountInboxAllRemotePartition(MiruRemotePartitionReader remotePartitionReader) {
        this.remotePartitionReader = remotePartitionReader;
    }

    private String getEndpoint(MiruPartitionId partitionId) {
        return COUNT_PREFIX + INBOX_ALL_QUERY_ENDPOINT + "/" + partitionId.getId();
    }
    ...
    public MiruPartitionResponse<DistinctCountAnswer> askRemote(MiruHost host,
        ...
        return remotePartitionReader.read("distinctCountInboxAll",
            host,
