...
public class MiruChromeRegion<I, R extends MiruPageRegion<I>> implements MiruRegion<I> {
    ...
    private final List<MiruCatwalkPlugin> plugins;
    private final R region;

    public MiruChromeRegion(String template, MiruSoyRenderer renderer, MiruHeaderRegion headerRegion, List<MiruCatwalkPlugin> plugins, R region) {
