 ...
 *
 */
public class StumptownAnswer implements Serializable {

    public static final StumptownAnswer EMPTY_RESULTS = new StumptownAnswer(null, true);

    public final Map<String, Waveform> waveforms;
    public final boolean resultsExhausted;

    @JsonCreator
    public StumptownAnswer(
