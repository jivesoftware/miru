 ...
 *
 */
public class StumptownAnswerEvaluator implements MiruAnswerEvaluator<StumptownAnswer> {

    @Override
    public boolean isDone(StumptownAnswer answer, MiruSolutionLog solutionLog) {
