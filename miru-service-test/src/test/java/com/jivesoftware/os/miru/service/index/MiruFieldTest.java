...
public class MiruFieldTest {
    ...
    public Object[][] miruFieldDataProvider() throws Exception {
        ...
        MiruContext<ImmutableRoaringBitmap, ?> hybridContext = IndexTestUtil.buildInMemoryContext(4, bitmaps, coord);
        MiruFieldIndex<ImmutableRoaringBitmap> hybridFieldIndex = hybridContext.fieldIndexProvider.getFieldIndex(MiruFieldType.primary);
        ...
        MiruFieldIndex<ImmutableRoaringBitmap> onDiskFieldIndex = onDiskContext.fieldIndexProvider.getFieldIndex(MiruFieldType.primary);
