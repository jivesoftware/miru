...
public enum MiruTestActivityType {
    ...
    contentItem((supplier, time) -> {
        ...
        MiruActivity activity = new MiruActivity.Builder(supplier.miruTenantId(), time, authz, 0)
            ...
            .putAllFieldValues(MiruFieldName.CONTAINER_IDS.getFieldName(), Lists.transform(containerIds, idToStringForm()))
            .putFieldValue(MiruFieldName.AUTHOR_ID.getFieldName(), authorId.toStringForm())
            .putFieldValue(MiruFieldName.VERB_SUBJECT_CLASS_NAME.getFieldName(), verbSubject.getClassName())
            .putAllFieldValues(MiruFieldName.PARTICIPANT_IDS.getFieldName(), Lists.transform(users.subList(0, participants), idToStringForm()))
            .putFieldValue(MiruFieldName.OBJECT_ID.getFieldName(), verbSubject.toStringForm())
            .putFieldValue(MiruFieldName.VIEW_CLASS_NAME.getFieldName(), "ContentVersionActivitySearchView")
            .putAllFieldValues(MiruFieldName.MENTIONED_USER_IDS.getFieldName(), Lists.transform(users.subList(1, 1 + userMentions), idToStringForm()))
            .putAllFieldValues(MiruFieldName.MENTIONED_CONTAINER_IDS.getFieldName(),
                Lists.transform(supplier.oldContainers(containerMentions), idToStringForm()))
            .build();
        return activity;
    }),
    comment((supplier, time) -> {
        int userMentions = supplier.numUserMentions();
        int containerMentions = supplier.numContainerMentions();
        int participants = supplier.numParticipants();
        List<Id> users = supplier.oldUsers(1 + Math.max(participants, userMentions));
        ...
        MiruActivity activity = new MiruActivity.Builder(supplier.miruTenantId(), time, authz, 0)
            .putFieldValue(MiruFieldName.ACTIVITY_PARENT.getFieldName(), contentItemId.toStringForm())
            .putAllFieldValues(MiruFieldName.CONTAINER_IDS.getFieldName(), Collections2.transform(containerIds, idToStringForm()))
            .putFieldValue(MiruFieldName.AUTHOR_ID.getFieldName(), authorId.toStringForm())
            .putFieldValue(MiruFieldName.VERB_SUBJECT_CLASS_NAME.getFieldName(), verbSubject.getClassName())
            .putAllFieldValues(MiruFieldName.PARTICIPANT_IDS.getFieldName(), Lists.transform(users.subList(0, participants), idToStringForm()))
            .putFieldValue(MiruFieldName.OBJECT_ID.getFieldName(), verbSubject.toStringForm())
    ...
    likeContentItem((supplier, time) -> {
        Id authorId = supplier.oldUsers(1).get(0);
        Id contentItemId = supplier.oldContentItem();
        Id contentAuthorId = supplier.contentAuthor(contentItemId);
        ObjectId contentItem1 = new ObjectId("Post", contentItemId);
        Id likeId = CompositeId.createOrdered("Like", supplier.tenantId(), authorId.toStringForm(), contentItem1.toStringForm());
        ...
        MiruActivity activity = new MiruActivity.Builder(supplier.miruTenantId(), time, authz, 0)
            ...
            .putFieldValue(MiruFieldName.AUTHOR_ID.getFieldName(), authorId.toStringForm())
            .putFieldValue(MiruFieldName.VERB_SUBJECT_CLASS_NAME.getFieldName(), verbSubject.getClassName())
            .putFieldValue(MiruFieldName.PARTICIPANT_IDS.getFieldName(), idToStringForm(contentAuthorId))
            .putFieldValue(MiruFieldName.OBJECT_ID.getFieldName(), verbSubject.toStringForm())
            .putFieldValue(MiruFieldName.VIEW_CLASS_NAME.getFieldName(), "LikeActivitySearchView")
            .build();
        return activity;
    }),
    likeComment((supplier, time) -> {
        Id authorId = supplier.oldUsers(1).get(0);
        Id commentId = supplier.oldComment();
        Id commentAuthorId = supplier.contentAuthor(commentId);
        ObjectId comment1 = new ObjectId("Comment", commentId);
        Id likeId = CompositeId.createOrdered("Like", supplier.tenantId(), authorId.toStringForm(), comment1.toStringForm());
        ObjectId verbSubject = new ObjectId("Like", likeId);
        ...
        MiruActivity activity = new MiruActivity.Builder(supplier.miruTenantId(), time, authz, 0)
            ...
            .putFieldValue(MiruFieldName.AUTHOR_ID.getFieldName(), authorId.toStringForm())
            .putFieldValue(MiruFieldName.VERB_SUBJECT_CLASS_NAME.getFieldName(), verbSubject.getClassName())
            .putFieldValue(MiruFieldName.PARTICIPANT_IDS.getFieldName(), idToStringForm(commentAuthorId))
            .putFieldValue(MiruFieldName.OBJECT_ID.getFieldName(), verbSubject.toStringForm())
            .putFieldValue(MiruFieldName.VIEW_CLASS_NAME.getFieldName(), "LikeActivitySearchView")
            .build();
        return activity;
    ...
    private static Function<Id, String> ID_TO_STRING_FORM = input -> input != null ? input.toStringForm() : null;

    private final ActivityGenerator generator;

    MiruTestActivityType(ActivityGenerator generator) {
    ...
    private static String idToStringForm(Id id) {
        return id != null ? id.toStringForm() : null;
    }

    private static Function<? super Id, String> idToStringForm() {
        return ID_TO_STRING_FORM;
    }
