...
public class MiruBitsAggregationTest {
    ...
    public void setUpMethod() throws Exception {
        EWAHCompressedBitmap a = BitsTestUtil.ewahBits(0, size, 1, 3);
        EWAHCompressedBitmap b = BitsTestUtil.ewahBits(0, size, 2);
        bitmaps = new EWAHCompressedBitmap[] { a, b };

        allOnes = BitsTestUtil.ewahBits(0, size, 1);
        only_0_4_8 = BitsTestUtil.ewahBits(0, size, 4);
        only_1_5_9 = BitsTestUtil.ewahBits(1, size, 4);
        only_2_6_10 = BitsTestUtil.ewahBits(2, size, 4);
        only_3_7_11 = BitsTestUtil.ewahBits(3, size, 4);
    }
