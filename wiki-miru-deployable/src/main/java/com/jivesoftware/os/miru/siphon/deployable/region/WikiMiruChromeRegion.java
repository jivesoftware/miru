...
public class WikiMiruChromeRegion<I, R extends MiruPageRegion<I>> implements MiruRegion<I> {
    ...
    public WikiMiruChromeRegion(String template, MiruSoyRenderer renderer, WikiMiruHeaderRegion headerRegion, List<MiruManagePlugin> plugins, R region) {
