...
import com.jivesoftware.os.miru.anomaly.deployable.SampleTrawl;
import com.jivesoftware.os.miru.anomaly.deployable.ServiceId;
 ...
 *
 */
// soy.anomaly.page.anomalyStatusPluginRegion
public class AnomalyStatusPluginRegion implements MiruPageRegion<Optional<AnomalyStatusPluginRegion.AnomalyStatusPluginRegionInput>> {
    ...
    public AnomalyStatusPluginRegion(String template,
    ...
    public static class AnomalyStatusPluginRegionInput {

        final String foo;

        public AnomalyStatusPluginRegionInput(String foo) {
    ...
    @Override
    public String render(Optional<AnomalyStatusPluginRegionInput> optionalInput) {
...
//        logMill.levelCounts.put(new ServiceId("ds", "c", "h", "s1", "i", "v"), "INFO", new AtomicLong(10));
        ...
        try {
            if (optionalInput.isPresent()) {
                AnomalyStatusPluginRegionInput input = optionalInput.get();
