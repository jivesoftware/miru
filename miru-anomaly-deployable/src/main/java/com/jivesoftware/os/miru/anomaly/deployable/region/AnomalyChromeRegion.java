 ...
 *
 */
// soy.anomaly.chrome.chromeRegion
public class AnomalyChromeRegion<I, R extends MiruPageRegion<I>> implements MiruRegion<I> {

    private final String template;
    private final MiruSoyRenderer renderer;
    private final MiruHeaderRegion headerRegion;
    private final List<AnomalyPlugin> plugins;
    private final R region;

    public AnomalyChromeRegion(String template, MiruSoyRenderer renderer, MiruHeaderRegion headerRegion, List<AnomalyPlugin> plugins, R region) {
