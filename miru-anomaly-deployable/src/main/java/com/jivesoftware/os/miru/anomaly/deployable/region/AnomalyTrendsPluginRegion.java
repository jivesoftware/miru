 ...
 *
 */
// soy.anomaly.page.trendsPluginRegion
public class AnomalyTrendsPluginRegion implements MiruPageRegion<Optional<AnomalyTrendsPluginRegion.TrendingPluginRegionInput>> {
    ...
    public AnomalyTrendsPluginRegion(String template,
