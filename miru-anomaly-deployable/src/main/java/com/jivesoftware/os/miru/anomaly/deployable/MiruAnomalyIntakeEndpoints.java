...
@Singleton
@Path("/miru/anomaly")
public class MiruAnomalyIntakeEndpoints {
    ...
    public MiruAnomalyIntakeEndpoints(@Context IngressGuaranteedDeliveryQueueProvider deliveryQueueProvider, @Context ObjectMapper mapper) {
